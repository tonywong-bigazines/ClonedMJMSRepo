...
namespace Mahjong.Migrations
{
    ...
    [Migration("20200618063730_AddHelpPlayInfo")]
    partial class AddHelpPlayInfo
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mahjong.Mahjong.Card", b =>
                {
            ...
            modelBuilder.Entity("Mahjong.Mahjong.MahJongAction", b =>
                {
                    ...
                    b.Property<string>("LoserAmountFormula")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Mahjong.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Mahjong.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Mahjong.Mahjong.PlayHistoryDetail", b =>
                {
                    ...
                    b.HasOne("Mahjong.Mahjong.PlayHistory", "PlayHistory")
                        .WithMany("PlayHistoryDetails")
                        .HasForeignKey("PlayHistoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
