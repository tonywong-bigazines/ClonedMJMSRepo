...
using Mahjong.Sessions;
using Mahjong.Web.Models.Account;
using Mahjong.Web.Views.Shared.Components.TenantChange;

namespace Mahjong.Web.Controllers
{
    public class AccountController : MahjongControllerBase
    {
